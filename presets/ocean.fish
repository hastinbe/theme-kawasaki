# Ocean preset
# Usage: kawasaki_preset ocean
# Calming ocean-inspired color palette (blues and teals)

# Ocean color palette
set -q theme_primary; or set -g theme_primary 4dd0e1  # Cyan
set -q theme_secondary; or set -g theme_secondary 26a69a  # Teal
set -q theme_primary_variant; or set -g theme_primary_variant 0097a7  # Dark cyan
set -q theme_secondary_variant; or set -g theme_secondary_variant 00897b  # Dark teal
set -q theme_hilight; or set -g theme_hilight 00acc1  # Light cyan
...
set -g theme_color_time 546e7a  # Blue gray
...
# Calming, balanced display - show time, hide group, show status info
